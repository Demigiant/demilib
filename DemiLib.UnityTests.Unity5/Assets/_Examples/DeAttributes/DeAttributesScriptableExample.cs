...
{
    [CreateAssetMenu(fileName = "DeAttributesScriptableExample", menuName = "Test/DeAttributesScriptableExample", order = 2)]
    [DeComponentDescription("This is a components description made with <b>DeComponentDescription</b>")]
    public class DeAttributesScriptableExample : ScriptableObject 
    {

                ...
                using (new GUILayout.VerticalScope(DeGUI.styles.box.stickyTop)) {
                    ...
                    using (new GUILayout.HorizontalScope()) {
                        ...
                        build.deleteDebugFolder = DeGUILayout.ToggleButton(
                            ...
                            new GUIContent(
                                "Delete Debug Folders",
                                "If selected, at the end of the build deletes the eventual \"don't ship\" folders generated by IL2CPP and Burst for debug purposes"
                            ),

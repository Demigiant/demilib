...
//                        Debug.Log("ContextClick > Background");
        ...
        void ContextMenu_Background()
        {
            ...
            menu.AddItem(new GUIContent("Capture screenshot (visible area)"), false, () => {
                _nodeProcess.CaptureScreenshot(NodeProcess.ScreenshotMode.VisibleArea, DG.DemiEditor.DeGUI.ShowTexturePreview);
            });
            menu.AddItem(new GUIContent("Capture screenshot (all nodes)"), false, () => {
                _nodeProcess.CaptureScreenshot(NodeProcess.ScreenshotMode.AllNodes, DG.DemiEditor.DeGUI.ShowTexturePreview);
            });
            menu.AddItem(new GUIContent("Capture screenshot (all nodes half scale)"), false, () => {
                _nodeProcess.CaptureScreenshot(NodeProcess.ScreenshotMode.AllNodes, DG.DemiEditor.DeGUI.ShowTexturePreview, 0.5f);
            });
